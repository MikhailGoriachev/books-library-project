...
exports.FileExtensionsService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const FileExtension_1 = require("../../entities/FileExtension");
const typeorm_2 = require("typeorm");
const utils_1 = require("../../../infrastructure/utils");
let FileExtensionsService = exports.FileExtensionsService = class FileExtensionsService {
    constructor(fileExtensionRepository) {
...
exports.FileExtensionsService = FileExtensionsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(FileExtension_1.FileExtension)),
