...
const sale_filter_dto_1 = require("../../../dto/filters/sale-filter.dto");
const Sale_1 = require("../../../database/entities/Sale");
const sale_dto_1 = require("../../../dto/crud/sale.dto");
...
let SalesController = exports.SalesController = class SalesController {
    ...
    create(item) {
        item.id = null;
        return this._salesService.save(Object.assign(new Sale_1.Sale(), item));
    }
    update(item) {
        return this._salesService.save(Object.assign(new Sale_1.Sale(), item));
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [sale_filter_dto_1.SaleFilterDto]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SalesController.prototype, "findOneById", null);
__decorate([
    (0, roles_decorator_1.Roles)(RolesEnum_1.RolesEnum.admin),
    (0, common_1.Post)(),
