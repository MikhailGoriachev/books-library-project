...
const user_dto_1 = require("../../../dto/crud/user.dto");
const user_filter_dto_1 = require("../../../dto/filters/user-filter.dto");
...
let UsersController = exports.UsersController = class UsersController {
    ...
    create(item) {
        item.id = null;
        return this._usersService.save(Object.assign(new User_1.User(), item));
    }
    update(item) {
        return this._usersService.save(Object.assign(new User_1.User(), item));
    }
