...
class UserSeeder {
    async run(dataSource, factoryManager) {
        await factoryManager.get(User_1.User).save(new User_1.User('guest', 'guest@gmail.com'));
        const admin = await factoryManager.get(User_1.User).save(new User_1.User('admin', 'admin@gmail.com'));
        const saltRounds = 10;
