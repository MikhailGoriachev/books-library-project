...
@Component({
    selector: 'app-author-statistic',
    templateUrl: './author-statistic.component.html',
    styleUrls: ['./author-statistic.component.css']
})
export class AuthorStatisticComponent {
    ...
    constructor(
        @Inject(MAT_DIALOG_DATA) public data: { report: AuthorReportDto, begin: Date, end: Date },
